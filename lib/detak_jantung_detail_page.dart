...
class SplinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path()
      ...
      ..cubicTo(size.width * 0.15, size.height * 0.5, size.width * 0.22, size.height * 0.7, size.width * 0.33, size.height * 0.4)
      ..cubicTo(size.width * 0.45, size.height * 0.2, size.width * 0.55, size.height * 0.65, size.width * 0.68, size.height * 0.35)
      ..cubicTo(size.width * 0.78, size.height * 0.15, size.width * 0.88, size.height * 0.5, size.width, size.height * 0.3);
    ...
    // Draw active dot at 08:00 (around x = width * 0.33, y = height * 0.4)
...
class DetakJantungDetailPage extends StatelessWidget {
  const DetakJantungDetailPage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // List of readings
            _buildTimeReadingItem('08:00', '78 bpm', 'Normal'),
            _buildTimeReadingItem('06:00', '82 bpm', 'Normal'),
            _buildTimeReadingItem('04:00', '65 bpm', 'Normal'),
            _buildTimeReadingItem('02:00', '60 bpm', 'Normal'),
            _buildTimeReadingItem('00:00', '62 bpm', 'Normal'),
            const SizedBox(height: 24),
