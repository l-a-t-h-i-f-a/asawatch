...
- [ ] Target harian yang bisa diatur pengguna dan disimpan. `target_harian.dart` beserta angka
      bawaannya (2000 kcal / 250 g / 60 g / 65 g) **sudah dihapus**, bukan dibiarkan menunggu:
      Beranda menampilkannya sebagai pembanding lengkap dengan bar kemajuan, padahal tidak seorang
      pun pernah memilih angka itu. `tujuan_kesehatan_page.dart` yang dulu menampung janji ini juga
      sudah dihapus (2026-09-02) — halamannya perlu ditulis ulang. Sampai target kalori sungguhan
      ada, ringkasan harian di Beranda menampilkan jumlah tanpa penyebut.
